...
- Recovery data seasons: [2016, 2017, 2018, 2019, 2021, 2022, 2023, 2024, 2025]
- Return events identified: 755
- Games with non-zero recovery adjustment: 335/1388
...
| Incumbent + Recovery (logit adj) | 0.6277 | 0.6361 | 0.6507 | 0.5964 |
| Recovery only | 0.6950 | 0.6993 | 0.6944 | 0.6914 |
...
|-------|------|-------|----------|
| Incumbent + Recovery (logit adj) | +0.0012 | -0.0045 | Loses val, wins hold |
| Recovery only | +0.0684 | +0.0548 | Worse on both |
